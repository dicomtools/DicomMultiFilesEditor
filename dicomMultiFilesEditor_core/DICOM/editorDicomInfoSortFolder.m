function tDataSets = editorDicomInfoSortFolder(link)
%function tDataSets = editorSortDicomFileList(tFileList, iNbFiles)
%Read DICOM Main Function.
...
% along with dicomMultiFilesEditor.  If not, see <http://www.gnu.org/licenses/>.
    ...
    [tFileList, iNbFiles] = editorGetDicomFileList(sDirName, tFileList);
    ...
    tDataSets = editorSortDicomFileList(tFileList, iNbFiles);
