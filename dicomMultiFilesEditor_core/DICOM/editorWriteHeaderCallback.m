...
% along with dicomMultiFilesEditor.  If not, see <http://www.gnu.org/licenses/>.
    ...
    yPosition = dScreenSize(4) * dDlgPosition(2) + ((ySize /2)-(100+(dPNOffset/2)));
    ...
    dlgWrite = ...
        dialog('Position', [xPosition ...
         ...
         uicontrol(dlgWrite,...
                   ...
                   'position', [20 165+dPNOffset 100 20]...
                   );        
    ...
    edtWriteGroup = ...
        uicontrol(dlgWrite,...
                  ...
                  'BackgroundColor', editorBackgroundColor('get'), ...
                  'ForegroundColor', editorForegroundColor('get'), ...                   
                  'position'  , [150 165+dPNOffset 100 20]...
                  );        
        ...
        uicontrol(dlgWrite,...
                  ...
                  'BackgroundColor', editorBackgroundColor('get'), ...
                  'ForegroundColor', editorForegroundColor('get'), ...                    
                  'position', [20 140+dPNOffset 100 20]...
                  );        
    ...
    edtWriteElement = ...
        uicontrol(dlgWrite,...
                  ...
                  'BackgroundColor', editorBackgroundColor('get'), ...
                  'ForegroundColor', editorForegroundColor('get'), ...                    
                  'position'  , [150 140+dPNOffset 100 20]...
                  );                        
        ...
        uicontrol(dlgWrite,...
                  ...
                  'BackgroundColor', editorBackgroundColor('get'), ...
                  'ForegroundColor', editorForegroundColor('get'), ...                    
                  'position', [20 115+dPNOffset 100 20]...
                  );        
    ...
    edtWriteVR = ...
        uicontrol(dlgWrite,...
                  ...
                  'BackgroundColor', editorBackgroundColor('get'), ...
                  'ForegroundColor', editorForegroundColor('get'), ...                    
                  'position'  , [150 115+dPNOffset 100 20]...
                  );  
