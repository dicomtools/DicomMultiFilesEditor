function setEditorObjectIcon(ptrObject)
%function setEditorObjectIcon(ptrObject)
%Set Editor icon to a dialog or figure.
...
%
% Copyright 2025, Daniel Lafontaine, on behalf of the dicomMultiFilesEditor development team.
%
