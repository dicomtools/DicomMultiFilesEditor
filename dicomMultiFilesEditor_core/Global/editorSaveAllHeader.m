function dAllHeader = editorSaveAllHeader(sAction, dValue)
%function dAllHeader = editorSaveAllHeader(sAction, dValue)
%Get/Set Export All DICOM Headers Value.
...
% along with dicomMultiFilesEditor.  If not, see <http://www.gnu.org/licenses/>.
    ...
    persistent dDefaultAllHeader;        

    if strcmpi('set', sAction)
        dDefaultAllHeader = dValue;
    end

    dAllHeader = dDefaultAllHeader;        
end