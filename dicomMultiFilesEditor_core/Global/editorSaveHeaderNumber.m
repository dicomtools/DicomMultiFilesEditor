function sHeaderNumber = editorSaveHeaderNumber(sAction, dValue)
%function sHeaderNumber = editorSaveHeaderNumber(sAction, dValue)
%Get/Set Save Header Number Value.
...
% along with dicomMultiFilesEditor.  If not, see <http://www.gnu.org/licenses/>.
    ...
    persistent sDefaultHeaderNumber;        

    if strcmpi('set', sAction)
        sDefaultHeaderNumber = dValue;
    end

    sHeaderNumber = sDefaultHeaderNumber;        
end