...
% along with dicomMultiFilesEditor.  If not, see <http://www.gnu.org/licenses/>.
    ...
    xPosition = dScreenSize(3) * dDlgPosition(1) + ((xSize /2)-460);

    ySize     = dScreenSize(4) * dDlgPosition(4);
    yPosition = dScreenSize(4) * dDlgPosition(2) + ((ySize /2)-230);


    if editorUIFigure('get') == true

        dlgOptions = ...
            uifigure('Position', [xPosition ...
                                yPosition ...
                                460 ...
                                230 ...
                                ],...
    ...
    setEditorObjectIcon(dlgOptions);
    ...
    txtDefTarget = ...
        uicontrol(dlgOptions,...
                  'style'   , 'text',...
                  'string'  , 'Select Destination Path',...
                  'horizontalalignment', 'left',...
                  'BackgroundColor', editorBackgroundColor('get'), ...
                  'ForegroundColor', editorForegroundColor('get'), ...
