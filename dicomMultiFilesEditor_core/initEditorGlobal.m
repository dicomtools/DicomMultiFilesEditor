...
% along with dicomMultiFilesEditor.  If not, see <http://www.gnu.org/licenses/>.
    ...
    dlgEditorWindowsPtr      ('set', '');    
    uiEditorMainWindowPtr    ('set', '');
    uiEditorProgressWindowPtr('set', '');
    
    lbEditorFilesWindowPtr('set', '');                 
    btnEditorSortFilesPtr ('set', '');
    
    lbEditorMainWindowPtr('set', '');                                
    
    btnEditorOpenPtr       ('set', '');
    btnEditorWriteHeaderPtr('set', '');
    btnEditorOptionsPtr    ('set', '');
    btnEditorGenUIDPtr     ('set', ''); 
